  ...
  return (
    ...
    <div className="space-y-10 anim-up pb-20">
      ...
      <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <p className="text-muted text-sm font-medium uppercase tracking-wider">Dónde recolectar ahora</p>
          </div>
      ...
      <div className="space-y-6">
        ...
        {favoriteSpecies.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-4">
              <p className="text-muted text-sm font-medium uppercase tracking-wider">{t.favoriteSpecies}</p>
