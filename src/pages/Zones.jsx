...
export default function Zones() {
  const { t, followedZones, toggleFollow, setSelectedZone, headerVisible } = useApp()
  ...
  useEffect(() => {
    ...
    const GAP            = 20  // space-y-5 entre sticky bar y mapa
    ...
    const compute = () => {
      ...
      const available = window.innerHeight - layoutHeaderH - aboveH - GAP - BOTTOM_MARGIN
