...
export default function Zones() {
  ...
  const filteredZones = useMemo(() => {
    ...
    return r
  }, [onlyFollowed, onlyRained, zoneSort, forestFilter, ccaaFilter, searchQuery, followedZones, conditionsMap])
          ...
          <div className="mb-5">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              {[
                ...
                <button key={op.id} onClick={() => setZoneSort(op.id)}
