...
export default function Species() {
  ...
  // (evita que cualquier ancestor con transform/backdrop-filter rompa position:fixed)
  const stickyStyle = {
    position: 'fixed',
    zIndex: 30,
  ...
  return (
    ...
    <div className="space-y-5 anim-up pb-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        {/* Placeholder invisible cuando search está en portal (preserva el espacio en el flex) */}
