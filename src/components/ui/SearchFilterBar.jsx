  ...
  return (
    <div className={`flex ${className}`} style={{ gap: '2px' }}>
      <div className="relative flex-1">
        <span className="absolute left-5 top-1/2 -translate-y-1/2 text-cream/85 pointer-events-none">{IC.search}</span>
        <input
          ref={inputRef}
          value={value}
          onChange={onChange}
          ...
          className="w-full glass text-cream text-sm outline-none placeholder-cream/85 pl-12 pr-12 transition-all duration-200"
