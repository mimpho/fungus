      ...
      <div className="relative rounded-2xl w-full max-w-sm p-6 anim-scale" style={{ background: MODAL.bg }}>
        ...
        {GOOGLE_CLIENT_ID && (
          <>
            ...
            {/* Overlay pattern: custom-styled div (visual) + Google's real button (invisible, on top).
                renderButton() works with FedCM; prompt() does not. */}
            <div className="relative w-full rounded-xl overflow-hidden">
              {/* Visual layer — decorative, not interactive */}
              <div
                className={`w-full flex items-center justify-center gap-3 py-2.5 text-sm font-medium bg-white/[0.06] text-cream transition-all pointer-events-none select-none ${googleLoading ? 'opacity-60' : ''}`}
              >
              ...
              {/* Google's real button — invisible overlay, handles all the auth */}
              <div
                ref={googleBtnRef}
