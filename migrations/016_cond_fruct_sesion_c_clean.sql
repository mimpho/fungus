-- 016_cond_fruct_sesion_c_clean.sql
-- Sesión C — familias pequeñas (41 especies)
-- Eliminados: esp-125 (Cortinariaceae ya migrada), esp-145 (Hygrophoraceae/sesión B),
--             esp-188 (duplicado de esp-189), esp-204 (ID no existe)
-- PENDIENTE: añadir esp-086 Tuber melanosporum cuando Gemini lo genere
-- Generado: 2026-03-14
